            ...
            <main>
                ...
                <div className="cards">
                    <div class="card text-center mb-3">
                        <div class="card-body">
                            <i class="bi bi-brush text-primary" style={{fontSize: 3 +'rem'}}></i>
                    ...
                    <div class="card text-center mb-3">
                        <div class="card-body">
                            <i class="bi bi-code-slash text-primary" style={{fontSize: 3 +'rem'}}></i>
                    ...
                    <div class="card text-center mb-3">
                        <div class="card-body">
                            <i class="bi bi-search text-primary" style={{fontSize: 3 +'rem'}}></i>
